...
class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
                ...
                self.bt1_2.setGeometry(QtCore.QRect(270, 175, 48, 26))
                ...
                self.bt1_3.setGeometry(QtCore.QRect(270, 250, 48, 26))
                ...
                self.at_4.setGeometry(QtCore.QRect(200, 325, 48, 26))
                ...
                self.bt1_4.setGeometry(QtCore.QRect(270, 325, 48, 26))
                ...
                self.bt1_5.setGeometry(QtCore.QRect(270, 400, 48, 26))
                ...
                self.label_priority.setGeometry(QtCore.QRect(130, 60, 51, 31))
                self.label_priority.setAlignment(QtCore.Qt.AlignCenter)
                self.label_priority.setObjectName("label_priority")
                self.label_priority.setText("Priority")

                self.bt_priority1 = QtWidgets.QSpinBox(self.centralwidget)
                self.bt_priority1.setEnabled(True)
                self.bt_priority1.setGeometry(QtCore.QRect(135, 100, 48, 26))
                self.bt_priority1.setMaximum(999)
                self.bt_priority1.setObjectName("bt_priority1")
                self.bt_priority1.setValue(5)

                self.bt_priority2 = QtWidgets.QSpinBox(self.centralwidget)
                self.bt_priority2.setEnabled(True)
                self.bt_priority2.setGeometry(QtCore.QRect(135, 175, 48, 26))
                self.bt_priority2.setMaximum(999)
                self.bt_priority2.setObjectName("bt_priority2")
                self.bt_priority2.setValue(4)

                self.bt_priority3 = QtWidgets.QSpinBox(self.centralwidget)
                self.bt_priority3.setEnabled(True)
                self.bt_priority3.setGeometry(QtCore.QRect(135, 250, 48, 26))
                self.bt_priority3.setMaximum(999)
                self.bt_priority3.setObjectName("bt_priority3")
                self.bt_priority3.setValue(3)

                self.bt_priority4 = QtWidgets.QSpinBox(self.centralwidget)
                self.bt_priority4.setEnabled(True)
                self.bt_priority4.setGeometry(QtCore.QRect(135, 325, 48, 26))
                self.bt_priority4.setMaximum(999)
                self.bt_priority4.setObjectName("bt_priority4")
                self.bt_priority4.setValue(2)

                self.bt_priority5 = QtWidgets.QSpinBox(self.centralwidget)
                self.bt_priority5.setEnabled(True)
                self.bt_priority5.setGeometry(QtCore.QRect(135, 400, 48, 26))
                self.bt_priority5.setMaximum(999)
                ...
                self.prsId2.setGeometry(QtCore.QRect(100, 175, 71, 25))
                font = QtGui.QFont()
                font.setBold(True)
                font.setWeight(75)
                ...
                self.prsId3.setGeometry(QtCore.QRect(100, 250, 71, 25))
                font = QtGui.QFont()
                font.setBold(True)
                font.setWeight(75)
                ...
                self.prsId4.setGeometry(QtCore.QRect(100, 325, 71, 25))
                font = QtGui.QFont()
                font.setBold(True)
                font.setWeight(75)
                ...
                self.prsId5.setGeometry(QtCore.QRect(100, 400, 71, 25))
                font = QtGui.QFont()
                font.setBold(True)
                font.setWeight(75)
                ...
                self.checkBox_1.setGeometry(QtCore.QRect(60, 100, 41, 23))
                ...
                self.checkBox_2.setGeometry(QtCore.QRect(60, 175, 41, 23))
                ...
                self.checkBox_3.setGeometry(QtCore.QRect(60, 250, 41, 23))
                ...
                self.checkBox_4.setGeometry(QtCore.QRect(60, 325, 41, 23))
                ...
                self.checkBox_5.setGeometry(QtCore.QRect(60, 400, 41, 23))
                ...
                self.label.setGeometry(QtCore.QRect(350, 100, 41, 41))
        ...
        "border-radius:20px;")
                ...
                self.label_2.setGeometry(QtCore.QRect(350, 180, 41, 41))
        ...
        "border-radius:20px;")
                ...
                self.label_3.setGeometry(QtCore.QRect(350, 260, 41, 41))
        ...
        "border-radius:20px;")
                ...
                self.label_4.setGeometry(QtCore.QRect(350, 340, 41, 41))
        ...
        "border-radius:20px;")
                ...
                self.label_5.setGeometry(QtCore.QRect(350, 420, 41, 41))
                ...
                self.label_51.setGeometry(QtCore.QRect(560, 90, 16, 375))
